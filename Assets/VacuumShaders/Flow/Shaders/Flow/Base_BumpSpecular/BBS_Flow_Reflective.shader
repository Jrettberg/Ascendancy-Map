...
Shader "VacuumShaders/Flow/Base_BumpSpecular/Flow_Reflective" {
		Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf Vacuum vertex:vert
		#pragma target 3.0
		...
		void surf (Input IN, inout VacuumSurfaceOutput o)
		 {
			...
			reflcol *=  _ReflColor.a;
			reflcol *= flowMap.b;

			o.Albedo = mainColor.rgb + finalD.rgb + reflcol;
